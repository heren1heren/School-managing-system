...
import dayjs from 'dayjs'; import { useDialogs } from './../../utilities/hooks/useDialogs/useDialogs.tsx';
...
export default function EmployeeShow() {
    ...
    const handleEmployeeEdit = React.useCallback(() => {
        navigate(`${CRUD_BASE}/employees/${employeeId}/edit`);
    }, [navigate, employeeId]);
    ...
    return (
        <PageContainer
            title={pageTitle}
            breadcrumbs={[
                { title: 'Employees', path: `${CRUD_BASE}/employees` },
                { title: pageTitle },
            ]}
        >
