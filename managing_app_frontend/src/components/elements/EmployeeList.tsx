...
import { useDialogs } from './../../utilities/hooks/useDialogs/useDialogs.tsx';
import useNotifications from './../../utilities/hooks/useNotifications/useNotifications.tsx';
import {
...
export default function EmployeeList() {
    ...
    const handleRowClick = React.useCallback<GridEventListener<'rowClick'>>(
        ({ row }) => {
            navigate(`${CRUD_BASE}/employees/${row.id}`);
        },
        [navigate],
    );

    const handleCreateClick = React.useCallback(() => {
        navigate(`${CRUD_BASE}/employees/new`);
    }, [navigate]);

    const handleRowEdit = React.useCallback(
        (employee: Employee) => () => {
            navigate(`${CRUD_BASE}/employees/${employee.id}/edit`);
        },
        [navigate],
    );
